 ...
 * @returns {Uint32Array}
 */
export function oriented_dimensions(src_w, src_h, orientation) {
    const ret = wasm.oriented_dimensions(src_w, src_h, orientation);
 ...
 * @returns {number}
 */
export function read_orientation(file_bytes) {
    const ptr0 = passArray8ToWasm0(file_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.read_orientation(ptr0, len0);
    return ret;
}
 ...
 * @returns {Uint8Array}
 */
export function transform(rgba, src_w, src_h, target_w, target_h, orientation, filter) {
    const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.transform(ptr0, len0, src_w, src_h, target_w, target_h, orientation, filter);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('img_ops_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
